...
QT_MOC_LITERAL(4, 49, 18), // "on_slot_SendResult"
QT_MOC_LITERAL(5, 68, 9), // "strResult"
QT_MOC_LITERAL(6, 78, 22), // "on_slot_OpendoorFinish"
QT_MOC_LITERAL(7, 101, 23), // "on_slot_ClosedoorFinish"
QT_MOC_LITERAL(8, 125, 14) // "on_slot_finish"

    },
    "CQRWidget\0on_btnBack_clicked\0\0"
    "on_btnHome_clicked\0on_slot_SendResult\0"
    "strResult\0on_slot_OpendoorFinish\0"
    "on_slot_ClosedoorFinish\0on_slot_finish"
};
...
void CQRWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_slot_SendResult((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->on_slot_OpendoorFinish(); break;
        case 4: _t->on_slot_ClosedoorFinish(); break;
        case 5: _t->on_slot_finish(); break;
        default: ;
        }
    }
}
