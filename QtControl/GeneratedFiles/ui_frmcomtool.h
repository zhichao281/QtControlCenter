...
public:
    ...
    void setupUi(QWidget *frmComTool)
    {
        ...
        frmRight = new QFrame(frmComTool);
        frmRight->setObjectName(QStringLiteral("frmRight"));
        frmRight->setMinimumSize(QSize(190, 0));
        frmRight->setMaximumSize(QSize(190, 16777215));
        frmRight->setFrameShape(QFrame::Box);
        frmRight->setFrameShadow(QFrame::Sunken);
        gridLayout_3 = new QGridLayout(frmRight);
        gridLayout_3->setObjectName(QStringLiteral("gridLayout_3"));
        labPortName = new QLabel(frmRight);
        labPortName->setObjectName(QStringLiteral("labPortName"));

        gridLayout_3->addWidget(labPortName, 0, 0, 1, 1);

        cboxPortName = new QComboBox(frmRight);
        ...
        btnOpen = new QPushButton(frmRight);
        btnOpen->setObjectName(QStringLiteral("btnOpen"));

        gridLayout_3->addWidget(btnOpen, 5, 0, 1, 2);

        tabWidget = new QTabWidget(frmRight);
        ...
        gridLayout_3->addWidget(tabWidget, 6, 0, 1, 2);


        gridLayout_6->addWidget(frmRight, 0, 1, 2, 1);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        cboxSend = new QComboBox(frmComTool);
        cboxSend->setObjectName(QStringLiteral("cboxSend"));
        sizePolicy1.setHeightForWidth(cboxSend->sizePolicy().hasHeightForWidth());
        cboxSend->setSizePolicy(sizePolicy1);
        cboxSend->setEditable(true);
        cboxSend->setDuplicatesEnabled(false);

        horizontalLayout->addWidget(cboxSend);

        btnSend = new QPushButton(frmComTool);
